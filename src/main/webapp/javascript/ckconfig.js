...
CKEDITOR.editorConfig = function (config) {
    ...
    config.contentsCss = ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/bootstrap-module/css/bootstrap.css';
    config.templates_files = [ ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/bootstrap-module/javascript/cktemplates.js' ];
